...
op/close dia each time you change your python code to see the results. CHris version was to fully python3 compatible so I fixed it with the v1.2. his version can not create objects as well. The new version will be
able to do so and uses pythondia helpers.
